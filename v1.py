...
billboard_points = np.array([[approx[0][0][0], approx[0][0][1]], [approx[3][0][0], approx[3][0][1]], [approx[2][0][0], approx[2][0][1]], [approx[1][0][0], approx[1][0][1]]], dtype=np.float32)
image_points = np.array([[0, 0], [poster.shape[1], 0], [poster.shape[1], poster.shape[0]], [0, poster.shape[0]]], dtype=np.float32)
